...
public interface CourseMapper {
	...
	@Select("select student.npm, name " + "from student join studentcourse "
    ...
    @Results(value = {
    		...
    		javaType = List.class, many=@Many(select="selectStudentByCourse"))})
	...
	@Select("select student.npm, name, gpa " +
    		...
    		List<StudentModel> selectStudentByCourse (@Param("idCourse") String idCourse);
